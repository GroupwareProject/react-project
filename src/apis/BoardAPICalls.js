import { GET_BOARD, POST_BOARD, PUT_BOARD, DELETE_BOARD } from '../modules/BoardModule';
...
export const callBoardUpdateAPI = ({form}) => {
    ...
    const requestURL = `http://${process.env.REACT_APP_RESTAPI_IP}:8282/api/v1/board/detail`;
